abstract final class AppStrings {
  ...
  static const String noteViewOrganized = '查看整理版';
  static const String noteReorganize = '重新整理';
  static const String noteDetailTitle = '笔记详情';
  static const String noteVersionList = '版本列表';
  static const String noteVersionKeepLatestFive = '删除旧版本（保留最近5）';
  static const String noteVersionKeepLatestOne = '仅保留最新版';
  static const String noteVersionNoHistory = '暂无历史版本';
  static const String notePreferenceHint = '整理偏好（可选）';
  static const String noteRegenerating = '正在重新整理...';
  static const String noteCancelRegenerate = '取消整理';
